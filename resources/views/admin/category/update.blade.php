...
@section('title', 'Catergory Update page')
@section('content')
            ...
            <div class="col-lg-6 offset-3">
                <div class="card">
                    <div class="card-body">
                        ...
                        <hr>
                        <form action="{{ route ('category#update' , $data->category_id) }}" method="post" novalidate="novalidate">
                            @csrf
                            <div class="form-group">
                                ...
                                <input id="cc-pament" name="updateName" type="text" class="form-control"
